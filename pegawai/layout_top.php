...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti Online Kelompok Ungu - <?php echo $pagedesc ?></title>
        ...
        <!-- Navigation -->
         <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php" style="font-size: 18px;">
					<img src="libs/images/cuti-logo.jpg" alt="brand" width="40" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong >KELOMPOK</strong>
						<div>
							&nbsp;<strong>UNGU</strong>
						</div>
						</div>
				...
				<a class="navbar-brand visible-xs" href="index.php">
					<img src="libs/images/cuti-logo.jpg" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>Kelompok Ungu</strong></div>
					<div class="clear-both"></div>
				</a>
			</div><!-- /.navbar-header -->

            <ul class="nav navbar-top-links navbar-right">
            	<li class="dropdown	"><h5 class="text-muted" style="color: #fcfdff;"><i class="fa fa-calendar fa-fw"></i>&nbsp;<?php echo $hari_ini.", ".$tanggal." ".$bulan_ini." ".$tahun ?></h5></li>

				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="#">
						<img src="../foto/<?php echo $res['foto_emp']?>" width="20px"></i>&nbsp;
						<?php echo ucfirst($sess_pegawainame); ?>&nbsp;<i class="fa fa-caret-down" style="color: white"></i>
					</a>
            ...
            <div class="navbar-navbar-success bg-success sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <!-- open <li> tag generated with php, see line 155-160 -->
							...
							<ul class="nav nav-second-level" style="color: white;">
								<?php
