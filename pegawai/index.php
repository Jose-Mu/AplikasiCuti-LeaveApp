<?php
	...
	$sqlb = "SELECT * FROM cuti WHERE npp='$id' AND stt_cuti like '%Menunggu Approval%'";
					...
					<div class="col-lg-12">
						<form class="form-horizontal">
							<div class="panel panel-default">
								...
								<h2 align="center" class="selamat">Selamat Datang, <?php echo $res['nama_emp'];?>!</h2>
								<hr/>
								<center><img src="../foto/<?php echo $res['foto_emp']?>" width="120px" style="border-radius: 8px;"></center>
								<hr/>
								</div>
							</div><!-- /.panel -->
						</form>
				...
				<div class="row">
					<div class="col-lg-4 col-md-4">
						<div class="panel panel-primary">
							...
							<a href="cuti_app.php">
								<div class="panel-footer panel-detail">
