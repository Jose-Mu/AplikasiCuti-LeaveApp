				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="libs/images/cuti-logo.jpg" alt="logo-dkm" width="70" style="border-radius: 8px; margin-left: 60px" />
						</td>
...
<br/>
	<section id="body-of-report">
		<div class="container-fluid">
			<h4 class="text-center" style="font-size: 16px; margin-top: -20px;"><strong>FORM PENGAJUAN CUTI (APPROVED)</strong></h4>
			<br />
...
<h3>
			...
			<br>
			<div>
			<label>*Laporan ini dicetak oleh sistem dan tidak memerlukan tanda tangan atau pengesahan lain.</label>
			</div>
