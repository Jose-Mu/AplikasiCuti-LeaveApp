						...
						<form class="form-horizontal" name="cuti" action="approval_update.php" method="POST" enctype="multipart/form-data" onSubmit="return valid();">
							<div class="panel panel-default">
								...
								<div class="panel-body">
									...
									<div class="form-group">
										<label class="control-label col-sm-3">Email Pemohon</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										...
										<div class="col-sm-4">
											<textarea name="reject" id="reject" class="form-control" placeholder="Keterangan Reject" rows="3" disabled></textarea> <br> <br>
										</div>
									</div>
								</div>
