										...
										<?php
											...
											while($data = mysqli_fetch_array($Qry)){
												...
												echo '<td class="text-center">
													  <a href="#myModal" data-toggle="modal" data-load-code="'.$data['no_cuti'].'" data-remote-target="#myModal .modal-body" class="btn btn-info btn-xs">Detail</a>';?>
													  <a href="approval_review.php?no=<?php echo $data['no_cuti'];?>" class="btn btn-warning btn-xs">Review</a></td>
												<?php
													  echo '</td>';
												echo '</tr>';												
												$i++;
