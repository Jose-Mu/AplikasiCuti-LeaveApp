					...
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<a href="karyawan_tambah.php" class="btn btn-info">Tambah</a>
							</div>
										...
										<?php
											...
											while($data = mysqli_fetch_array($ress)) {
												...
												echo '<td class="text-center">
													  <a href="#myModal" data-toggle="modal" data-load-code="'.$data['npp'].'" data-remote-target="#myModal .modal-body" class="btn btn-info btn-xs">Detail</a>
