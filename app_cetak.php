				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="libs/images/cuti-logo.jpg" alt="logo-dkm" width="70" style="margin-left:100px;" />
						</td>
...
<br/>
	<section id="body-of-report">
		<div class="container-fluid">
			<h4 class="text-center" style="font-size: 16px; margin-top: -20px;"><b>LAPORAN PENGAJUAN CUTI (APPROVED)</b></h4>
			<br>
