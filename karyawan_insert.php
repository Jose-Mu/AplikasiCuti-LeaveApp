...
if($rowscek<1){
	$sql="INSERT INTO employee(npp,nama_emp,jk_emp,telp_emp,divisi,jabatan,alamat,hak_akses,jml_cuti,password,foto_emp,active,id_adm,email)
		  VALUES('$npp','$nama','$jk','$telp','$divisi','$jabatan','$alamat','$akses','$jml','$npp','$newfoto','$aktif','$id','$email')";
